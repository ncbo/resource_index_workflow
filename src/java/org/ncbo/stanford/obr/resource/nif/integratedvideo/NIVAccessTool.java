 ...
 */
package org.ncbo.stanford.obr.resource.nif.integratedvideo;
...
public class NIVAccessTool extends AbstractNifResourceAccessTool {
    ...
    // Constant 
    private static final String Database = "NIF Integrated Video";
    private static final String Indexable = "Videos";
