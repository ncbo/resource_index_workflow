...
public class GENETAccessTool extends AbstractNifResourceAccessTool{
    ...
    private static final String GENET_ELT_URL = "http://www.genenetwork.org/webqtl/WebQTL.py?FormID=showDatabase&database=";    
    private static final String[] GENET_ITEMKEYS = {"Gene_Name", "Gene_Symbol", "Chromosome_location", "Tissue", "Organism","Originating_database"};
    private static final Double[] GENET_WEIGHTS = {1.0, 0.9, 0.7, 0.9, 0.8,0.5};
                ...
                if(dom != null){
                    ...
                    for (int i = 0; i < rows.getLength(); i++) {
                        ...
                        for (int j = 0; j < row.getChildNodes().getLength(); j++) {
                            ...
                            if (name.equalsIgnoreCase(GENET_Gene_Name)) {                       //Gene_Name 
                                elementAttributes.put(Structure.generateContextName(GENET_RESOURCEID, GENET_ITEMKEYS[0]), value);                                                
                            } else if (name.equalsIgnoreCase(GENET_Gene_Symbol)) {              //Gene_Symbol & localElementId
                                ...
                                elementAttributes.put(Structure.generateContextName(GENET_RESOURCEID, GENET_ITEMKEYS[1]), Jsoup.parse(value).text());
